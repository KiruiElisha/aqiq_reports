...
frappe.socketio.socket_connection_failed = true;  // Disable socket.io connection attempts
...
frappe.query_reports["Statement Details"] = {
    ...
    //                 frappe.call({
    //                     method: 'impala.impala.doctype.customer_scheduler.customer_scheduler.send_email_statement_detail_on_specific_email',
    //                     args: {
    //                         'filters' : filters,
    ...
    //         var filters = report.get_values();
    //         frappe.call({
    //             method: 'impala.impala.doctype.customer_scheduler.customer_scheduler.generate_pdf_statement_detail',
    //             args: {
    //                 'filters' : filters,
    //             },
    //             freeze: true,
...
frappe.ready(function() {
    if (typeof erpnext !== 'undefined' && erpnext.utils) {
        erpnext.utils.add_dimensions('Statement Details', 15);
    }
});
